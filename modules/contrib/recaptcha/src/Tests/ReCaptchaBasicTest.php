...
class ReCaptchaBasicTest extends WebTestBase {
  ...
  public function testReCaptchaOnLoginForm() {
    ...
    //$this->assertRaw('<script src="https://www.google.com/recaptcha/api.js?hl=' . \Drupal::service('language_manager')->getCurrentLanguage()->getId() . '"></script>', '[testReCaptchaOnLoginForm]: reCAPTCHA is shown on form.');
